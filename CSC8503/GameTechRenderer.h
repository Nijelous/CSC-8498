...
namespace NCL {
	...
	namespace CSC8503 {
		...
		public:
			...
			vector<string>	SortMeshes(const std::vector<std::string>& details);
			void		LoadMeshes(std::unordered_map<std::string, Mesh*>& meshMap, const std::vector<std::string>& details) override;
